...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400&family=Noto+Sans+KR:wght@100;300&display=swap" rel="stylesheet">
...
<main>
    <div class="category-header" style="text-align: center; padding-top: 80px; margin-bottom: 60px;">
        <h2 style="font-weight: 300; letter-spacing: 15px; text-transform: uppercase; color: #111; font-size: 28px; font-family: 'Cormorant Garamond', serif;">
            ${categoryName}
        </h2>
    </div>
...
<footer>
    © 2026 LALA BOUTIQUE. ALL RIGHTS RESERVED.
</footer>

<a class="footer-del">DELETE ACCOUNT</a>
